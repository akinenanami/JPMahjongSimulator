...
public:
    ...
    bool sanankoJudge(std::vector<std::vector<uint8_t>> hand_divided,
                      std::vector<Exposure> & exposures, uint8_t _card, int card_from);                                         //三暗刻
    ...
    bool suankoJudge(std::vector<std::vector<uint8_t>> hand_divided,
                     std::vector<Exposure> & exposures, uint8_t _card, int card_from);                                          //四暗刻
